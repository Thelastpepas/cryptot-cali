...
from crypto.encrypt import encrypt_message, decrypt_message, format_output
...
class TestCryptoMethods(unittest.TestCase):
    ...
    def test_encrypt_valid_key_length_16(self):
        # Test encryption with a valid 16 bytes key
    ...
    def test_format_output_base64(self):
        # Test output formatting to Base64
    ...
    def test_format_output_hexadecimal(self):
        # Test output formatting to Hexadecimal
        data = b"data to format"
    ...
    def test_format_output_binario(self):
        # Test output formatting to Binary
        data = b"\x01\x02"
    ...
    def test_format_output_decimal(self):
        # Test output formatting to Decimal
        data = b"\x01\x02\x03"
    ...
    def test_format_output_octal(self):
        # Test output formatting to Octal
        data = b"\x01\x02\x03"
    ...
    def test_decrypt_invalid_base64(self):
        ...
        with self.assertRaises(ValueError):
            decrypt_message("invalid_base64", self.valid_key_16)  # Expecting a ValueError
    ...
    def test_encrypt_long_message(self):
        # Test encryption of a long message (1000 characters)
        long_message = "A" * 1000  
        encrypted = encrypt_message(long_message, self.valid_key_32)
        self.assertTrue(encrypted)  # Ensure encryption produces a result

    def test_decrypt_long_message(self):
        # Test decryption of a long message (1000 characters)
        long_message = "A" * 1000  
        encrypted = encrypt_message(long_message, self.valid_key_32)
        decrypted = decrypt_message(encrypted, self.valid_key_32)
